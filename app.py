...
def home():
    ...
    <body>
      <header>
  <img src="{{ url_for('static', filename='logo.png') }}" alt="CDI Logo" style="height:120px; float:left; margin-right:15px;">
  ...
  <img src="{{ url_for('static', filename='logo.png') }}" alt="Tree planting" style="width: 45%;">
</div>
...
def about():
    ...
    <body>
      <header>
  <img src="{{ url_for('static', filename='logo.png') }}" alt="CDI Logo" style="height:100px; float:left; margin-right:15px;">
...
def projects():
    ...
    <body>
      <header>
        <img src="{{ url_for('static', filename='logo.png') }}" alt="CDI Logo" class="logo">
        <h1>Our Projects</h1>
      </header>
